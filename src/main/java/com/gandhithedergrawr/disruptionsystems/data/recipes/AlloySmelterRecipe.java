...
public class AlloySmelterRecipe implements IAlloySmelterRecipe{
    ...
    public IRecipeSerializer<?> getSerializer() {
        return ModRecipeTypes.ALLOYING_SERIALIZER.get();
    }

    public static class AlloyingRecipeType implements IRecipeType<AlloySmelterRecipe>{
    ...
    public static class Serializer extends ForgeRegistryEntry<IRecipeSerializer<?>>
        ...
        public AlloySmelterRecipe read(ResourceLocation recipeId, JsonObject json) {
            ...
            return new AlloySmelterRecipe(recipeId, output, inputs);
        }
