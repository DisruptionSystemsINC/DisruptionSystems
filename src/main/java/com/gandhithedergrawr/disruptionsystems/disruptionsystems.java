package com.gandhithedergrawr.disruptionsystems;
...
@Mod("disruptionsystems")
public class disruptionsystems {
    public static final String MOD_ID = "disruptionsystems";

    // Directly reference a log4j logger.
    private static final Logger LOGGER = LogManager.getLogger();

    public disruptionsystems() {
    ...
    private void enqueueIMC(final InterModEnqueueEvent event) {
        ...
        InterModComms.sendTo("disruptionsystems", "helloworld", () -> { LOGGER.info("Hello world from the MDK"); return "Hello world";});
    }
